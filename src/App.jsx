...
import logoEscuela from './assets/images/logoEscuela.svg';
import logoUpm from './assets/images/logoUpm.svg';
import Libre from "!url-loader?limit=65536!./assets/fonts/LibreSemiSansSSI.ttf";
import OCR from "!url-loader?limit=32768!./assets/fonts/OCR-A.ttf";
...
class App extends React.Component {
  handleClick() {
    ...
    tableLevel2(doc,'Dirección IP','https://github.com/JesusMartinezRuano/react-pdfkit-webpack');
